...
<div class="container-fluid">
    ...
    <div class="container col-lg-6 col-md-6 col-sm-6 col-xs-6  mt-5" style="padding-top:50px;">
    ...
    <div class=" container pt-4" style="margin-top: 20px;">
            ...
            <input type="submit" value="Submit" name="addsubmit" class="rounded" style="background-color:#28A745;">
