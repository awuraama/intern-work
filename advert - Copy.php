...
// print_r($list);
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg   navbar-dark fixed-top" style="background-color:  #05294b;">
            ...
            <div class="container">
                <a href="#" class="navbar-brand"> SansPareil.Rentals :: <em> car advertisement </em></a>
            ...
            <div class="row  justify-content-around align-item-center">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 rounded" style="margin-bottom:30px;">
                    <div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <ul>
                                                ...
                                                <li>isAvailable:</li>
                                                <li>mileage:</li>
                                                <li>Registration number:<?php echo $value['registration_no'] ;?></li>
                                                <li>insurance code:</li>
                                            </ul>
                                            </p>
                                        </div>
                        ...
                        <img src="casset/c7.PNG" alt="car" style="width:100%;">
                        </center>
 ...
 <?php
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 rounded" style="margin-bottom:30px;">
                    ...
                    <div>
                        ...
                        <center><img src="casset/c8.PNG" alt="car" style="width:90%;"></center>
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 rounded" style="margin-bottom:30px;">
                    <div>
                        ...
                        <center><img src="casset/c9.PNG" alt="car" style="width:90%;"></center>
                ...
                <div class="row  justify-content-around align-item-center">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 rounded" style="margin-bottom:30px;">
                        <div>
                            ...
                            <center><img src="casset/c12.PNG" alt="car" style="width:80%;"></center>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 rounded" style="margin-bottom:30px;">
                        <div>
                            ...
                            <center><img src="casset/c10.PNG" alt="car" style="width:85%;"></center>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 rounded" style="margin-bottom:30px;">
                        <div>
                            ...
                            <center><img src="casset/c11.PNG" alt="car" style="width:100%;"></center>
        ...
        <button type="change" id="change" value="change" name="change"
                class="p-2 px-5 mt-3 rounded bg-primary float-end text-light m-5" onclick=""><a href="changepassword.php" style="text-decoration:none; color:#fff"> Change Password</a></button>
            <button type="add" id="add" value="add" name="add"
                class="p-2 px-5 mt-3 rounded bg-success float-end text-light m-5" onclick="">Add A Car</button>
        </div>
